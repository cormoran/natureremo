...
// Get MeasuredInstantaneous with Watt unit.
...
// Get NormalDirectionCumulativeElectricEnergy with watt hour unit.
...
// Get ReverseDirectionCumulativeElectricEnergy with watt hour unit.
